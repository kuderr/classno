...
def performance_data():
    ...
    return {
        ...
        "deeply_nested": {
            "level_0": {"level_1": {"level_2": {"level_3": "deep_value"}}}
        },
    }
...
class TestHelpers:
    ...
    def assert_independent_objects(obj1, obj2, mutable_attr_name):
        ...
        assert (
            attr1 is not attr2
        ), f"Objects share the same {mutable_attr_name} instance"
